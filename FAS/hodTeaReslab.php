...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/hod.css">
    <!-- Font Awesome  -->
...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <div class="navbarCenter">
            <h4 style="font-weight:1000">HOD ==> Teacher</h4>
        </div>
    ...
    <form action="backend/hodTeaRlab.php?courseID=<?php echo $courseID; ?>&username=<?php echo $username; ?>" method="post">
        <main>
...
########################################################################################################### -->
            ...
            <div class="leftDisplayBox">
                <table class="table table-bordered" cellspacing="0" style="border:none;margin:1rem auto; width:50%">
                    <?php
                    echo '<th>';
                    for ($i = 1; $i <= 6; $i++) {
                        echo '<th>CO' . $i . '</th>';
...
<div class="div1">PREVIOUS RESPONSE GIVEN TO TEACHER</div>
            ...
            include "backend/include/conn.php";
            $courseID = $_GET['courseID'];
            $sql1 = "select teacher from hod_feedbackl WHERE courseID='$courseID' and teacher is not NULL ";
...
########################################################################################################### -->
            ...
            <div class="div1">SUGGESTION TO TEACHER</div>
            <div class="leftDisplayBox">
                <p><textarea type="text" name="finalSugg" id="finalSugg" style=" text-align:left; resize:none; height:5rem; width:30rem;  margin-top: .8rem;" placeholder="Enter Response for teacher" require></textarea></p>
                <input type="submit" name="submit" value="Submit" style="margin:1rem 44% 1rem" class="btn btn-success"></input>
            </div>
