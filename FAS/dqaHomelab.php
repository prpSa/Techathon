...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <div class="navbarCenter">
            <h4 style="font-weight:1000">DQA Lab Home</h4>
        </div>
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown" >
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="dqaHome.php?username=<?php echo $username; ?>" class="dropdown-item" style="font-size:1rem; font-weight:600">DQA Home</a>
    ...
    <main>
        ...
        $sql1 = "select courseID,courseName from coursel ";
