...
<form method="POST" style="background-color:white" action="auditorHome.php?username=<?php echo $username;?>">
<div class="table1" style="background-color:white">
    ...
    <tr>
        ...
        <td><a target='_blank' href="backend/auditorViewDocII.php?courseID=<?php echo $courseID;?>&name=prerequisite"><input type='viewDoc' name='prerequisite' value='View' class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'/></a></td>   
        ...
        <td><a target='_blank' href="backend/auditorViewDocII.php?courseID=<?php echo $courseID;?>&name=documentsVerified"><input type='viewDoc' name='documentsVerified'style="padding:3px 0px; width:50%" value='View' class="btn btn-success" readonly='readonly'/></a></td>   
    ...
    <tr>
        ...
        <td><a target='_blank' href="backend/auditorViewDocII.php?courseID=<?php echo $courseID;?>&name=defaulterList"><input type='viewDoc' name='defaulterList' value='View' class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'/></a></td>   
    ...
    <tr>
        ...
        <td><a target='_blank' href="backend/auditorViewDocII.php?courseID=<?php echo $courseID;?>&name=lms"><input type="viewDoc" name="lms" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td> 
    ...
    <tr>
        ...
        <td><a target='_blank' href="backend/auditorViewDocII.php?courseID=<?php echo $courseID;?>&name=dcf"><input type="viewDoc" name="dcf" value="View" class="btn btn-success"  style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>   
    ...
    <tr>
        ...
        <td><a target='_blank' href="backend/auditorViewDocII.php?courseID=<?php echo $courseID;?>&name=eAttendance"><input type="viewDoc" name="eAttendance" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>  
    ...
    <tr>
        ...
        <td><a target='_blank' href="backend/auditorViewDocII.php?courseID=<?php echo $courseID;?>&name=syllabusCoverage"><input type="viewDoc" name="syllabusCoverage" value="View" class="btn btn-success" style="padding:3px 0px; width:50%"readonly='readonly'></input></a></td>  
    ...
    <tr>
        ...
        <td><a target='_blank' href="backend/auditorViewDocII.php?courseID=<?php echo $courseID;?>&name=workshopConduction"><input type="viewDoc" name="workshopConduction" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>  
    ...
    <tr>
        ...
        <td><a target='_blank' href="backend/auditorViewDocII.php?courseID=<?php echo $courseID;?>&name=identifyStudents"><input type="viewDoc" name="identifyStudents" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>  
    ...
    <tr>
        ...
        <td><a target='_blank' href="backend/auditorViewDocII.php?courseID=<?php echo $courseID;?>&name=evaluationLabs"><input type="viewDoc" name="evaluationLabs" value="View" class="btn btn-success" style="padding:3px 0px; width:50%"readonly='readonly'></input></a></td>   
    ...
    <tr>
        ...
        <td><a target='_blank' href="backend/auditorViewDocII.php?courseID=<?php echo $courseID;?>&name=additionalExperiments"><input type="viewDoc" name="additionalExperiments" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>  
