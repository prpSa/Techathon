...
<div class="bs-example">
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown" >
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="http://localhost/FAS/lab.php?username=<?php echo $username;?>" class="dropdown-item" style="font-size:1rem; font-weight:600"><i class="fas fa-plus-square fa-sm fa-fw mr-2 text-gray-400"></i>Create New Form</a>
    ...
    if ( $total1 != 0) { 
         while($result1=mysqli_fetch_assoc($data1)) {
            ...
            ';
            include "teacherTemplatelab.php";
            echo '</div>';
