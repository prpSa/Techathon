...
if (isset($_POST['save'])) {
    ...
    $sql1 = "SELECT courseID FROM `course` WHERE courseName= '$courseName' AND fromAcadYr='$fromAcademicYear'";
    ...
    $sql = "UPDATE `course` SET `toAcadYr`='$toAcademicYear',`credits`='$credits',`lectHr`='$lectureHoursPerWeek',`totLectHr`='$totalContactHours' WHERE `courseID`='$courseID'";
