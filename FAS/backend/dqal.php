...
if (isset($_POST['submit']) && !empty($_POST['submit'])) {
    ...
    if ($conn->query($sql) == true) {
        $sql_update = "UPDATE `hodhomel` SET `teacher`='" . $dqaStatus . "' ,`dqa`='Napproved'  WHERE `courseID`='$courseID' ";
        ...
        $mail->Body="Response for the below mentioned Course hash been submitted. Course Details: CourseID:$courseID
        Status: $dqaStatus <br><br>Regards<br>Admin<br>Faculty Audit System" ;
