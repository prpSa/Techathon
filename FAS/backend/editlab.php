...
if(isset($_POST['save'])){
    ...
    $sql_hod = "UPDATE `hodhomel` SET `teacher`='submitted' WHERE `courseID`='$courseID' ";
    $query_hod = mysqli_query($conn, $sql_hod);

    $sql_hodd = "DELETE FROM `hodhometeal` WHERE `courseID`='$courseID' ";
    $query_hodd = mysqli_query($conn, $sql_hodd);
