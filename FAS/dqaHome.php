...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/dqaHome.css">
    <!-- Font Awesome  -->
...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <div class="navbarCenter">
            <h4 style="font-weight:1000">DQA Home</h4>
        </div>
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown" >
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="dqaHomelab.php?username=<?php echo $username; ?>" class="dropdown-item" style="font-size:1rem; font-weight:600">Lab Home</a>
    ...
    <main>
        ...
        $sql1 = "select courseID,courseName from course where dept in(select dept from users where username='$username' AND role='dqa') ";
        ...
        if ($total1 != 0) {
            ...
            while ($result1 = mysqli_fetch_assoc($data1)) {
                ...
                if ($total != 0) {
                    ...
                    <p style=" margin:.5rem; padding: 5px;text-align:right;margin-right: 90px;">See Responses:</p>
                    ';
                        include "dqaTemplate.php";
                        echo '</div>';
                    }
                } else {
                    echo "0 results";
