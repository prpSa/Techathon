...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <div class="navbarCenter">
            <h4 style="font-weight:1000">External Auditor-Response I</h4>
        </div>
    ...
    <main>
        ...
        <form method="POST" style="background-color:white" action="extAud1.php?username=<?php echo $audUsername; ?>&courseID=<?php echo $courseID; ?>&teaUsername=<?php echo $teaUsername;?>&division=<?php echo $division; ?>&subjectCode=<?php echo $subjectCode; ?>">
