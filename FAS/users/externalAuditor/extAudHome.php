...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light">
            <div id="navbarCollapse" class="collapse navbar-collapse">
                ...
                <div class="navbarLeft">
                    <a href="http://localhost/FAS/users/externalAuditor/extAudHome.php?username=<?php echo $username; ?>"><img src="../../css/images/dylogo.png" style="width:10rem; height:4rem"></a>
                </div>
    ...
    <main>
        <form method="post" action="extAudHome_backend.php">
            <div class="box">
                <div class="card">
                    <div class="selectbox">
    ...
    <script>
        $(document).ready(function() {
            function loadData(type, category1, category2, category3) {
                $.ajax({
            ...
            $("#sem").on("change", function() {
                ...
                loadData("sub", year, sem, dept);
            })
        })
    </script>
</body>
<?php include "extAudHome_backend.php"; ?>
