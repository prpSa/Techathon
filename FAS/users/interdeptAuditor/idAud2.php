...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <div class="navbarCenter">
            <h4 style="font-weight:1000">Inter-Departmental Auditor-Response II</h4>
        </div>
    ...
    <main>
        ...
        <form method="POST" style="background-color:white" action="idAud2.php?username=<?php echo $audUsername; ?>&courseID=<?php echo $courseID; ?>&teaUsername=<?php echo $teaUsername;?>&division=<?php echo $division; ?>&subjectCode=<?php echo $subjectCode; ?>">
