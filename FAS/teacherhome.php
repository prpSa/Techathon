...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <div class="navbarCenter">
            <h4 style="font-weight:1000">Teacher Home</h4>
        </div>
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown" >
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="http://localhost/FAS/subjectTeacherHome.php?username=<?php echo $username; ?>" class="dropdown-item" style="font-size:1rem; font-weight:600"><i class="fas fa-home fa-sm fa-fw mr-2 text-gray-400"></i>Subject Teacher Home</a>
  ...
  <main>
    ...
    $sql1 = "SELECT courseID,sub_name from hodhomee where tea_username='$username' and teaType='speTea' ";
