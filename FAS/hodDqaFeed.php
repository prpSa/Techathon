...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <div class="navbarCenter">
            <h4 style="font-weight:1000">HOD Response</h4>
        </div>
    ...
    <main>
        ...
        <div class="div1" style="width:80%">FEEDBACK
        </div>
        <?php
        ...
        if ($total1 != 0) {
            $i = 1;
            echo '<div class="leftDisplayBox" style="overflow:auto; max-height:550px; width:80%">
        ...
        <a href="http://localhost/FAS/dqaHome.php?username=<?php echo $username; ?>"><input type="submit" name="save" id="save" value="Back to Homepage" style="margin:2rem 44% 1rem" class="btn btn-success"></input> </a>
