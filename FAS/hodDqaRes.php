...
<div class="bs-example">
    ...
    <form action="backend/hodDqaR.php?courseID=<?php echo $courseID; ?>&username=<?php echo $username; ?>" method="post">
        <main>
...
<div class="div1">PREVIOUS RESPONSE GIVEN TO DQA</div>
            ...
            include "backend/include/conn.php";
            $courseID = $_GET['courseID'];
            $sql1 = "select dqaTeam from hod_feedback WHERE courseID='$courseID' and dqaTeam is not NULL ";
