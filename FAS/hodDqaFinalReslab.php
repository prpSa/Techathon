...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <a href="http://localhost/FAS/hodhomelab.php?username=<?php echo $username; ?>"><img src="dylogo.png" style="width:10rem; height:4rem" ></a>
        </div>

        <div class="navbarCenter">
            <h4 style="font-weight:1000">DQAL LAB => TEACHER Response</h4>
        </div>
    ...
    <form action="http://localhost/FAS/hodhomelab.php?username=<?php echo $username; ?>" method="post">
        <main>
...
########################################################################################################### -->
            ...
            <div class="leftDisplayBox" style="overflow:auto; max-height:550px; max-width:97%">
                ...
                <table class="table table-bordered" style="text-align: left; margin:2rem auto; width:40%">
            ...
            <input type="submit" name="submit" value="Back To Homepage" style="margin:1rem 43%" class="btn btn-success" />
