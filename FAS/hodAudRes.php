...
<div class="bs-example">
    ...
    <form method="POST" action="backend/hodAud1R.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&username=<?php echo $username; ?>">
        <div class="leftDisplayBox" style="margin:0px auto; text-align: left;">
            <table class="table table-bordered" style="text-align: left; margin:1rem auto; width:80%">
                ...
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocSub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=lms"><input type="viewDoc" name="lms" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" style="text-align: center;" readonly='readonly'></input></a></td>
                ...
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocSub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=dcf"><input type="viewDoc" name="dcf" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" style="text-align: center;" readonly='readonly'></input></a></td>
                ...
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocSub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=eAttendance"><input type="viewDoc" name="eAttendance" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" style="text-align: center;" readonly='readonly'></input></a></td>
                ...
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocSub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=syllabusCoverage"><input type="viewDoc" name="syllabusCoverage" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" style="text-align: center;" readonly='readonly'></input></a></td>
                ...
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocSub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=identifyStudents"><input type="viewDoc" name="identifyStudents" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" style="text-align: center;" readonly='readonly'></input></a></td>
                ...
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocSub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=evaluationLabs"><input type="viewDoc" name="evaluationLabs" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" style="text-align: center;" readonly='readonly'></input></a></td>
                ...
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocSub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=workshopConduction"><input type="viewDoc" name="workshopConduction" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" style="text-align: center;" readonly='readonly'></input></a></td>
                ...
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocSub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=epi"><input type="viewDoc" name="epi" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" style="text-align: center;" readonly='readonly'></input></a></td>
                ...
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocSub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=sampleCopies"><input type="viewDoc" name="sampleCopies" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" style="text-align: center;" readonly='readonly'></input></a></td>
                </tr>
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocSub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=ict"><input type="viewDoc" name="ict" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" style="text-align: center;" readonly='readonly'></input></a></td>
                ...
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocSub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=smartBoard"><input type="viewDoc" name="smartBoard" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" style="text-align: center;" readonly='readonly'></input></a></td>

                </tr>
            </table>
        </div>
        <div class="div1" style="text-align:center;margin: 10px auto; max-width:80%">SUGGESTION GIVEN BY INTERNAL AUDITOR
</div>
...
<div class="div1" style="max-width:80%">PREVIOUS RESPONSE GIVEN TO AUDITOR</div>
            ...
            include "backend/include/conn.php";
            $courseID = $_GET['courseID'];
            $sql1 = "select auditor1 from hodfeedback WHERE courseID='$courseID' and auditor1 is not NULL ";
