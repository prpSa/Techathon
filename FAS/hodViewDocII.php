...
<div class="bs-example">
    ...
    <form method="POST" action="backend/hodAudRII.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&username=<?php echo $username; ?>&audType='aud2' ">
        <div class="leftDisplayBox" style="margin:0px auto; text-align: left;">
            <table class="table table-bordered" style="text-align: left; margin:1rem auto; width:80%">
                ...
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocIISub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=lms"><input type="viewDoc" name="lms" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" readonly="readonly" style="text-align: center;"></input></a></td>

                </tr>
                <tr>
                    <td style="text-align:left"> 5] </td>
                    <td style="text-align:left"> DCF and its consistency with course file contents</td>
                    <td><a target='_blank' href="backend/auditorViewDocIISub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=dcf"><input type="viewDoc" name="dcf" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" readonly="readonly" style="text-align: center;"></input></a></td>

                </tr>
                <tr>
                    <td style="text-align:left"> 6] </td>
                    <td style="text-align:left">E-attendance & consistency with course coverage & other subject teachers</td>
                    <td><a target='_blank' href="backend/auditorViewDocIISub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=eAttendance"><input type="viewDoc" name="eAttendance" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" readonly="readonly" style="text-align: center;"></input></a></td>

                </tr>
                <tr>
                    <td style="text-align:left"> 7] </td>
                    <td style="text-align:left">Syllabus coverage and its consistency with the number of classes allocated</td>
                    <td><a target='_blank' href="backend/auditorViewDocIISub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=syllabusCoverage"><input type="viewDoc" name="syllabusCoverage" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" readonly="readonly" style="text-align: center;"></input></a></td>

                </tr>
                <tr>
                    <td style="text-align:left"> 8] </td>
                    <td style="text-align:left">Workshops/ expert lecture conduction</td>
                    <td><a target='_blank' href="backend/auditorViewDocIISub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=workshopConduction"><input type="viewDoc" name="workshopConduction" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" readonly="readonly" style="text-align: center;"></input></a></td>
                ...
                <tr>
                    ...
                    <td><a target='_blank' href="backend/auditorViewDocIISub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=identifyStudents"><input type="viewDoc" name="identifyStudents" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" readonly="readonly" style="text-align: center;"></input></a></td>

                </tr>
                <tr>
                    <td style="text-align:left"> 11] </td>
                    <td style="text-align:left">Continuous evaluation in labs</td>
                    <td><a target='_blank' href="backend/auditorViewDocIISub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=evaluationLabs"><input type="viewDoc" name="evaluationLabs" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" readonly="readonly" style="text-align: center;"></input></a></td>

                </tr>
                <tr>
                    <td style="text-align:left"> 12] </td>
                    <td style="text-align:left">Additional experiments/Mini Projects</td>
                    <td><a target='_blank' href="backend/auditorViewDocIISub.php?courseID=<?php echo $courseID; ?>&division=<?php echo $division; ?>&name=additionalExperiments"><input type="viewDoc" name="additionalExperiments" value="View" class="btn btn-success" style="padding:3px 0px; width:35%" readonly="readonly" style="text-align: center;"></input></a></td>
...
<div class="div1" style="max-width:80%">PREVIOUS RESPONSE GIVEN TO TEACHER</div>
            ...
            $courseID = $_GET['courseID'];
            $sql1 = "select audit2 from hodfeedback WHERE courseID='$courseID' and audit2 is not NULL ";
