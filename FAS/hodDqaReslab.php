...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <div class="navbarCenter">
            <h4 style="font-weight:1000">HOD ==> Dqa Response</h4>
        </div>
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown" >
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="http://localhost/FAS/hodhomelab.php?username=<?php echo $username; ?>" class="dropdown-item" style="font-size:1rem; font-weight:600"><i class="fas fa-home fa-sm fa-fw mr-2 text-gray-400"></i>Home Page</a>
    ...
    <form action="backend/hodDqaRlab.php?courseID=<?php echo $courseID; ?>&username=<?php echo $username; ?>" method="post">
        <main>
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                <div class="leftDisplayBox" style="overflow:auto; max-height:550px;  width:70%">
                    <table class="table table-bordered" style="text-align: left; margin:2rem auto; width:70%">
                        ...
                        echo "<th>PSO_no</th><th>PSO_description</th>";
                        if ($totalpsout != 0) {
                            // output data of each row
...
########################################################################################################### -->
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                <div class="leftDisplayBox" style="overflow:auto; max-height:550px;  width:70%">
                    <table class="table table-bordered" cellspacing="0" style="border:none;margin:1rem auto; width:50%" id="table_field_expList">
                        <?php
                        include "backend/include/conn.php";
                        $courseID = $_GET['courseID'];
                        echo "<tr><td></td>";
...
<!-- ###########################################################################################################
                               PREVIOUS RESPONSE GIVEN TO DQA:
########################################################################################################### -->

<div class="div1">PREVIOUS RESPONSE GIVEN TO DQA</div>
            <?php
            include "backend/include/conn.php";
            $courseID = $_GET['courseID'];
            $sql1 = "select dqaTeam from hod_feedbackl WHERE courseID='$courseID' and dqaTeam is not NULL ";
...
########################################################################################################### -->
            ...
            <div class="leftDisplayBox" style="overflow:auto; max-height:550px; max-width:97%">
                <table class="table table-bordered" style="text-align: left; margin:2rem auto; width:50%">
                    ...
                    if ($total != 0) {
                        while ($result = mysqli_fetch_assoc($data)) {
                            echo "<tr><td>Final Suggestion: </td><td>" . $result['finalSugg'] . "</td></tr>";
                        }
                    } else {
                        echo "0 results";
                    }
...
########################################################################################################### -->
            ...
            <div class="leftDisplayBox" style="overflow:auto; max-height:550px; max-width:97%">
                <p><textarea type="text" name="finalSugg" id="finalSugg" style="resize:none; height:5rem; width:30rem;  margin-top: .8rem;" placeholder="Enter Response for Dqa Team " require></textarea></p>
                <input type="submit" name="submit" value="Submit" style="margin:1rem auto" class="btn btn-success" />
            </div>
