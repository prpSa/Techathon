...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <div class="navbarCenter">
            <h4 style="font-weight:1000">HOD Feedback==> DQA</h4>
        </div>
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown" >
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="http://localhost/FAS/teacherhome.php?username=<?php echo $username; ?>" class="dropdown-item" style="font-size:1rem; font-weight:600"><i class="fas fa-home fa-sm fa-fw mr-2 text-gray-400"></i>Home Page</a>
    ...
    <form action="http://localhost/FAS/teacherhome.php?username=<?php echo $username; ?>" method="post">
        <main>
            ...
            <a href="http://localhost/FAS/teacherHome.php?username=<?php echo $username; ?>"><input style="margin:2rem 44% 1rem" class="btn btn-success" type="submit" name="save" id="save" value="Back To HomePage"></a>
