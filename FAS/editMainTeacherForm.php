...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/teacherEditPage.css">
    <!-- Font Awesome  -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var html_chpPlan = ' <tr><td><input class="form-control" style="align-items: center; max-width: 120px;" type="text" name="Chp_no[]" placeholder="1" d=""></td><td><textarea class="form-control" style="align-items: center; resize:none; height:3.5rem; width: 600px;" type="text" name="topic[]" placeholder="ABCD" d=""></textarea></td><td><input class="form-control" style="align-items: center; max-width: 80px;" type="text" name="CO_nooo[]" placeholder="CO1" d=""></td><td><input class="form-control" style="align-items: center; max-width: 101px;" type="text" name="weightage[]"placeholder="10" d=""></td><td><input class="form-control" style="align-items: center; max-width: 100px;" type="text" name="duration[]" placeholder="10" d=""></td><td><input class="btn btn-danger" type="button" name="remove_chpPlan" id="remove_chpPlan" value="remove"></td></tr>';
...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <div class="navbarCenter">
            <h4 style="font-weight:1000">Edit Teacher Form</h4>
        </div>
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown" >
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="http://localhost/FAS/teacherhome.php?username=<?php echo $username; ?>" class="dropdown-item" style="font-size:1rem; font-weight:600">Home Page</a>
    ...
    <form action="backend/editMainTeacherFormBack.php?courseID=<?php echo $courseID; ?>&username=<?php echo $username; ?>" method="POST">
        <main>
<!-- ###########################################################################################################
                                            COURSE DETAILS
########################################################################################################### -->
                ...
                <table class="table table-bordered" style="text-align: left; margin:1rem auto; width:28%">
                    ...
                    if ($total != 0) {
                        ...
                        while ($result = mysqli_fetch_assoc($data)) {
                            echo "
                                <tr><td>fromAcadYr</td><td><input id='year1' name='year1' type='text' class='form-control' placeholder='2021' value='" . $result['fromAcadYr'] . "' required=''></td></tr>
                                <tr><td>toAcadYr</td><td><input id='year2' name='year2' type='text' class='form-control' placeholder='2022' value='" . $result['toAcadYr'] . "' required=''></td></tr>
                                <tr><td>sem</td><td><input id='sem' name='sem' type='text' placeholder='4' class='form-control' value='" . $result['sem'] . "' required=''></td></tr>
                                <tr><td>subjectCode</td><td><input id='subcode' name='subcode' type='text' class='form-control' placeholder='CSC305' value='" . $result['subjectCode'] . "' required=''></td></tr>
                                <tr><td>courseName</td><td><input id='cname' name='cname' type='text' class='form-control'  placeholder='New course name' value='" . $result['courseName'] . "' readonly required=''></td></tr>
                                <tr><td>credits</td><td><input id='cred' name='cred' type='text' class='form-control' placeholder='10' value='" . $result['credits'] . "' required=''></td></tr>
                                <tr><td>lectHr</td><td><input id='lec' name='lec' type='text' placeholder='22' class='form-control'  value='" . $result['lectHr'] . "' required=''></td></tr>
                                <tr><td>totLectHr</td><td><input id='contact' name='contact' type='text' class='form-control' placeholder='67' value='" . $result['totLectHr'] . "' required=''></td></tr>";
                        }
                    } else {
                        echo "0 results";
                    }
...
########################################################################################################### -->
            ...
            <div class="leftDisplayBox" style="overflow-x:auto">
                <div class="input-field-outcome">
                    <table class="table table-bordered" style="margin:1rem auto; width:70%" cellspacing="0" style="border:none;" id="table_field_outcome">
                        <?php
                        include "backend/include/conn.php";
...
########################################################################################################### -->
            ...
            <div class="leftDisplayBox" style="padding:20px; overflow-x:auto">
                <table class="table table-bordered" style="margin:1rem auto; width:90%">
                    <?php
                    include "backend/include/conn.php";
                    $totalCo = 0;
                    $totalPo = 0;
                        ...
                        for ($j = 1; $j <= $totalPo; $j++) {
                            ...
                            if ($totalm_copo4 != 0) {
                                ...
                                while ($resultm_copo4 = mysqli_fetch_assoc($datam_copo4)) {
                                    echo "<th><input class='form-control' style='align-items: center; max-width: 50px;'' name='rco" . $i . "cpo" . $j . "' id='rco" . $i . "cpo" . $j . "' type='text' value='" . $resultm_copo4['rating'] . "'></th>";
                                }
                            } else {
                                echo "0 results";
                            }
...
########################################################################################################### -->
            ...
            <div class="leftDisplayBox">
                <div class="input-field_progOut">
                    <table class="table table-bordered" style="margin:1rem auto; width:70%" cellspacing="0" style="border:none;" id="table_field_progSpecOut">
                        <tr>
                            <th>PSO_no</th>
...
########################################################################################################### -->
            ...
            <div class="leftDisplayBox" style="overflow-x:auto">
                <table class="table table-bordered" style="margin:1rem auto; width:32%">
                    <?php
                    include "backend/include/conn.php";
                    $totalCos = 0;
                    $totalPso = 0;
                        ...
                        for ($j = 1; $j <= 3; $j++) {
                            ...
                            if ($totalm_copso4 != 0) {
                                ...
                                while ($resultm_copso4 = mysqli_fetch_assoc($datam_copso4)) {
                                    echo "<td><input type='text' class='form-control' id='rcoo" . $i . "cpoo" . $j . "' name='rcoo" . $i . "cpoo" . $j . "' style='align-items: center; max-width: 50px;'value='" . $resultm_copso4['rating'] . "'</input></td>";
                                }
                            } else {
                                echo "0 results";
                            }
...
########################################################################################################### -->
            ...
            <div class="leftDisplayBox">
                <div class="input-field_coWeight">
                    <table class="table table-bordered" style="margin:1rem auto; width:70%" cellspacing="0" style="border:none;" id="table_field_coWeight">
                        <?php
                        include "backend/include/conn.php";
                        ...
                        if ($totalpsout != 0) {
                            ...
                            while ($resultpsout = mysqli_fetch_assoc($datapsout)) {
                                echo "<tr><td><input class='form-control' style='align-items: center; max-width: 80px;' type='text' name='CO_noo[]' value='" . $resultpsout['CO_no'] . "'></td><td><input class='form-control' style='align-items: center; max-width: 100px;' type='text' name='noOfExp[]' value='" . $resultpsout['noOfExp'] .  "'></td><td><input class='form-control' style='align-items: center; max-width: 140px;' type='text' name='weightagePercent[]' value='" . $resultpsout['weightagePercent'] . "'></td><td><input class='btn btn-danger' type='button' name='remove_coWeight' id='remove_coWeight' value='remove'></td></tr>";
                            }
                        } else {
                            echo "0 results";
                        }
...
########################################################################################################### -->
            ...
            <div class="leftDisplayBox" style="overflow-x:auto">
                <div class="input-field_chpPlan">
                    <table class="table table-bordered" style="margin:1rem auto; width:70%" cellspacing="0" style="border:none;" id="table_field_chpPlan">
                        <?php
                        include "backend/include/conn.php";
                ...
                <th>duration</th><th><input class='btn btn-warning' type='button' name='add_chpPlan' id='add_chpPlan' value='Add'></th></tr>";
                        if ($total_chpPlan != 0) {
                            ...
                            while ($result_chpPlan = mysqli_fetch_assoc($data_chpPlan)) {
                                echo "<tr> <td><input class='form-control' style='align-items: center; max-width: 120px;' type='text' name='Chp_no[]' value='" . $result_chpPlan['chp_expNo'] . "' ></td><td><textarea class='form-control' style='align-items: center; resize:none; height:3.5rem; width: 400px;' type='text' name='topic[]' value='" . $result_chpPlan['chp_expTopic'] . "' >" . $result_chpPlan['chp_expTopic'] . "</textarea></td><td><input class='form-control' style='align-items: center; max-width: 80px;' type='text' name='CO_nooo[]' value='" . $result_chpPlan['CO_meet'] . "' ></td><td><input class='form-control' style='align-items: center; max-width: 101px;' type='text' name='weightage[]' value='" . $result_chpPlan['chp_exp_weightage'] . "' ></td><td><input class='form-control' style='align-items: center; max-width: 100px;' type='text' name='duration[]' value='" . $result_chpPlan['duration'] . "' ></td><td><input class='btn btn-danger' type='button' name='remove_chpPlan' id='remove_chpPlan' value='remove'></td></tr>";
                            }
                        } else {
                            echo "0 results";
                        }
...
########################################################################################################### -->
            ...
            <div class="leftDisplayBox" style="overflow-x:auto; max-height:600px; overflow-y:auto;">
                <div class="input-field_lesPlan">
                    <table class="table table-bordered" style="margin:1rem auto; width:70%" cellspacing="0" style="border:none;" id="table_field_lesPlan">
                        <?php
                        include "backend/include/conn.php";
                ...
                <td><input class="form-control" style="align-items: center; max-width: 110px;" type="text" name="Weightage' . $i . $j . '" placeholder="ABCD"  value="' . $result_lesPlan["weightage"] . '"></td>
                <td><input class="form-control" style="align-items: center; resize:none; height:3rem; width: 160px;" type="text" name="TeachingMethod' . $i . $j . '" placeholder="ABCD"  value="' . $result_lesPlan["teachingMethod"] . '"></td>               
            </tr>';
                                    }
                                } else {
                                    echo "0 results";
                    ...
                    for ($k = 1; $k <= 2; $k++) {
                        ...
                        for ($i = 1; $i <= 3; $i++) {
                            ...
                            for ($j = 1; $j <= 6; $j++) {
                                ...
                                if ($total_ia != 0) {
                                    while ($result_ia = mysqli_fetch_assoc($data_ia)) {
                                        echo "<td><input class='form-control' style='align-items: center; max-width: 50px;'' type='text' id=t" . $k . "q" . $i . "c" . $j . " name=t" . $k . "q" . $i . "c" . $j . "  value='" . $result_ia['marks'] . "' /></td>";
                                    }
                                } else {
                                    echo "0 results";
                                }
...
########################################################################################################### -->
            ...
            <div class="leftDisplayBox" style="overflow-x:auto; margin:2rem auto 20px">
                ...
                <input class="btn btn-success" style=" margin:2rem auto 2rem" type="submit" name="save" id="save" value="Submit">
            </div>
