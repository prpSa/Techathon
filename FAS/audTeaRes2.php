            ...
            <div class="table1" style="background-color:white">
                <table class="table2" cellspacing="0" style="text-align: left; margin:1rem auto; width:80%; color:black">
                    ...
                    <tr>
                        ...
                        <td><a target='_blank' href="backend/teaViewDoc2.php?username=<?php echo $username; ?>&courseID=<?php echo $courseID; ?>&name=prerequisite"><input type='viewDoc' name='prerequisite' value='View' class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly' /></a></td>
                    ...
                    <tr>
                        ...
                        <td><a target='_blank' href="backend/teaViewDoc2.php?username=<?php echo $username; ?>&courseID=<?php echo $courseID; ?>&name=documentsVerified"><input type='viewDoc' name='documentsVerified' style="padding:3px 0px; width:50%" value='View' class="btn btn-success" readonly='readonly' /></a></td>
                    ...
                    <tr>
                        ...
                        <td><a target='_blank' href="backend/teaViewDoc2.php?username=<?php echo $username; ?>&courseID=<?php echo $courseID; ?>&name=defaulterList"><input type='viewDoc' name='defaulterList' value='View' class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly' /></a></td>
                    ...
                    <tr>
                        ...
                        <td><a target='_blank' href="backend/teaViewDoc2.php?username=<?php echo $username; ?>&courseID=<?php echo $courseID; ?>&name=lms"><input type="viewDoc" name="lms" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>
                    ...
                    <tr>
                        ...
                        <td><a target='_blank' href="backend/teaViewDoc2.php?username=<?php echo $username; ?>&courseID=<?php echo $courseID; ?>&name=dcf"><input type="viewDoc" name="dcf" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>
                    ...
                    <tr>
                        ...
                        <td><a target='_blank' href="backend/teaViewDoc2.php?username=<?php echo $username; ?>&courseID=<?php echo $courseID; ?>&name=eAttendance"><input type="viewDoc" name="eAttendance" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>
                    ...
                    <tr>
                        ...
                        <td><a target='_blank' href="backend/teaViewDoc2.php?username=<?php echo $username; ?>&courseID=<?php echo $courseID; ?>&name=syllabusCoverage"><input type="viewDoc" name="syllabusCoverage" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>
                    ...
                    <tr>
                        ...
                        <td><a target='_blank' href="backend/teaViewDoc2.php?username=<?php echo $username; ?>&courseID=<?php echo $courseID; ?>&name=workshopConduction"><input type="viewDoc" name="workshopConduction" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>
                    ...
                    <tr>
                        ...
                        <td><a target='_blank' href="backend/teaViewDoc2.php?username=<?php echo $username; ?>&courseID=<?php echo $courseID; ?>&name=identifyStudents"><input type="viewDoc" name="identifyStudents" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>
                    ...
                    <tr>
                        ...
                        <td><a target='_blank' href="backend/teaViewDoc2.php?username=<?php echo $username; ?>&courseID=<?php echo $courseID; ?>&name=evaluationLabs"><input type="viewDoc" name="evaluationLabs" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>
                    ...
                    <tr>
                        ...
                        <td><a target='_blank' href="backend/teaViewDoc2.php?username=<?php echo $username; ?>&courseID=<?php echo $courseID; ?>&name=additionalExperiments"><input type="viewDoc" name="additionalExperiments" value="View" class="btn btn-success" style="padding:3px 0px; width:50%" readonly='readonly'></input></a></td>

                    </tr>

                </table>
            </div>
            <div class="Submit" style="text-align:center">SUGGESTION GIVEN BY INTERNAL AUDITOR
            </div>
            <div class="Feedback">
                <table cellspacing="5">
                    <?php include "backend/include/conn.php";
