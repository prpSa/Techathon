...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <div class="navbarCenter">
            <h4 style="font-weight:1000">DQA FORM</h4>
        </div>
    ...
    <form action="backend/dqa.php?username=<?php echo $username; ?>&courseID=<?php echo $courseID; ?>" method="POST">
...
########################################################################################################### -->
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                ...
                <div class="rightInputBox" style="width:25%">
                    ...
                    <p><textarea type="text" name="cdSugg" id="cdSugg" style=" margin-top: .8rem; width:14rem;  resize:none;" placeholder="Enter Suggestion if any"></textarea></p>
                </div>
            </div>
...
########################################################################################################### -->
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                ...
                <div class="rightInputBox" style="width:25%">
                    ...
                    <p><textarea type="text" name="courseObjSugg" id="courseObjSugg" style=" margin-top:15px; resize:none;" placeholder="Enter Suggestion if any"></textarea></p>
                </div>
            </div>
            <!-- ###########################################################################################################
                                            COURSE OUTCOME
########################################################################################################### -->
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                ...
                <div class="rightInputBox" style="width:25%">
                    ...
                    <p><textarea type="text" name="courseOutSugg" id="courseOutSugg" style=" margin-top: .8rem; width:14rem;  resize:none;" placeholder="Enter Suggestion if any"></textarea></p>
                </div>
            </div>
...
########################################################################################################### -->
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                ...
                <div class="rightInputBox" style="width:25%">
                    ...
                    <p><textarea type="text" name="progOutSugg" id="progOutSugg" style=" margin-top: .8rem; width:14rem;  resize:none;" placeholder="Enter Suggestion if any"></textarea></p>
                </div>
            </div>
...
########################################################################################################### -->
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                ...
                <div class="rightInputBox" style="width:25%">
                    ...
                    <label for="m_copo">Yes</label>&emsp;
                    <input type="radio" style="height: 1.5rem; width:1.5rem;" id="m_copo" name="m_copo" value="no">
                    <label for="m_copo">No</label><br>
                    <p><textarea type="text" name="m_copoSugg" id="m_copoSugg" style=" margin-top: .8rem; width:14rem;  resize:none;" placeholder="Enter Suggestion if any"></textarea></p>
                </div>
            </div>
...
########################################################################################################### -->
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                ...
                <div class="rightInputBox" style="width:25%">
                    ...
                    <label for="pso">Yes</label>&emsp;
                    <input type="radio" style="height: 1.5rem; width:1.5rem;" id="pso" name="pso" value="no">
                    <label for="pso">No</label><br>
                    <p><textarea type="text" name="psoSugg" id="psoSugg" style=" margin-top: .8rem; width:14rem;  resize:none;" placeholder="Enter Suggestion if any"></textarea></p>
                </div>
            </div>
...
########################################################################################################### -->
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                ...
                <div class="rightInputBox" style="width:25%">
                    ...
                    <label for="m_copsoYes">Yes</label>&emsp;
                    <input type="radio" style="height: 1.5rem; width:1.5rem;" id="m_copso" name="m_copso" value="no">
                    <label for="m_copsoNo">No</label><br>
                    <p><textarea type="text" name="m_copsoSugg" id="m_copsoSugg" style=" margin-top: .8rem; width:14rem;  resize:none" placeholder="Enter Suggestion if any"></textarea></p>
                </div>
            </div>
...
########################################################################################################### -->
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                ...
                <div class="rightInputBox" style="width:25%">
                    ...
                    <label for="courseWeigYes">Yes</label>&emsp;
                    ...
                    <p><textarea type="text" name="courseWeigSugg" id="courseWeigSugg" style=" margin-top: .8rem; width:14rem;  resize:none;" placeholder="Enter Suggestion if any"></textarea></p>
                </div>
            </div>
...
########################################################################################################### -->
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                ...
                <div class="rightInputBox" style="width:25%">
                    <p style=" margin:.5rem; padding: 5px;">Suggestion Required?</p>
                    <input type="radio" style="height: 1.5rem; width:1.5rem;" id="chpPlan" name="chpPlan" value="yes">
                    <label for="chpPlan">Yes</label>&emsp;
                    <input type="radio" style="height: 1.5rem; width:1.5rem;" id="chpPlan" name="chpPlan" value="no">
                    <label for="chpPlan">No</label><br>
                    <p><textarea type="text" name="chpPlanSugg" id="chpPlanSugg" style=" margin-top: .8rem; width:14rem;  resize:none;" placeholder="Enter Suggestion if any"></textarea></p>
                </div>
            </div>
...
########################################################################################################### -->
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                <div class="leftDisplayBox" style=" overflow:auto; height:550px; width:70%">
                ...
                <div class="rightInputBox" style="width:25%">
                    <p style=" margin:.5rem; padding: 5px;">Suggestion Required?</p>
                    <input type="radio" style="height: 1.5rem; width:1.5rem;" id="lesPlan" name="lesPlan" value="yes">
                    <label for="lesPlan">Yes</label>&emsp;
                    <input type="radio" style="height: 1.5rem; width:1.5rem;" id="lesPlan" name="lesPlan" value="no">
                    <label for="lesPlan">No</label><br>
                    <p><textarea type="text" name="lesPlanSugg" id="lesPlanSugg" style=" margin-top: .8rem; width:14rem;  resize:none;" placeholder="Enter Suggestion if any"></textarea></p>
                </div>
            </div>
...
########################################################################################################### -->
            ...
            <div class="outerBox" style="display:flex; flex-direction: row;">
                <div class="leftDisplayBox" style="width:70%">
                    <table class="table table-bordered" style="text-align: left; margin:2rem auto; width:70%">
                        <?php
                        include "backend/include/conn.php";
                ...
                <div class="rightInputBox" style=" height: 280px; width:25%">
                    <p style=" margin:.5rem; padding: 5px;">Suggestion Required?</p>
                    <input type="radio" style="height: 1.5rem; width:1.5rem;" id="ia" name="ia" value="yes">
                    <label for="ia">Yes</label>&emsp;
                    <input type="radio" style="height: 1.5rem; width:1.5rem;" id="ia" name="ia" value="no">
                    <label for="ia">No</label><br>
                    ...
                    <label for="btLevelYes">Yes</label>&emsp;
                    &emsp;
                    ...
                    <label for="grammarYes">Yes</label>&emsp;
                    &emsp;
                    <input type="radio" style="height: 1.5rem; width:1.5rem;" id="grammar" name="grammar" value="no">
                    <label for="grammarNo">No</label><br>
                    <p><textarea type="text" name="iaSugg" id="iaSugg" style=" margin-top: .8rem; width:14rem; resize:none;" placeholder="Enter Suggestion if any"></textarea></p>
