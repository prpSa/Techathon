...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <div class="navbarCenter">
            <h4 style="font-weight:1000">HOD Feedback==> Auditor</h4>
        </div>
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown" >
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="http://localhost/FAS/audhome.php?username=<?php echo $username; ?>" class="dropdown-item" style="font-size:1rem; font-weight:600"><i class="fas fa-home fa-sm fa-fw mr-2 text-gray-400"></i>Home Page</a>
    ...
    <main>
        ...
        if (strcmp('aud1',$audType) === 0){
            $column = 'auditor1';
        }
        else if(strcmp('aud2',$audType) === 0 ){
            $column = 'auditor2';
        }

        $sql1 = "SELECT * FROM `hodfeedback` where courseID='$courseID' and division='$division' and $column is not null ";
        ...
        if ($total1 != 0) {
            $i = '1';
            echo '<div class="leftDisplayBox">
            <table class="table2" cellspacing="0" style="width:90%; margin:0px auto; " >
            <tr>
                <th>Sr.No.</th>
                <th>Feedback</th>
            </tr> ';
        ...
        <a href="http://localhost/FAS/audHome.php?username=<?php echo $username; ?>"><input style="margin:2rem 44% 1rem" class="btn btn-success" type="submit" name="save" id="save" value="Back To Homepage"> </a>
