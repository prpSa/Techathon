...
<?php
    ...
    <?php
         $username = $_GET['username'];?>
      <a href="http://localhost/FAS/dqaHomelab.php?username=<?php echo $username;?>">  <input class="btn btn-success" style="margin:2rem 44% 1rem" type="submit" name="save" id="save" value="Back To Homepage"> </a>
